  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 animate-fade-in">
        ...
        <Card className="glass-morphism border-gray-700">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-white">Current Month Overview - {currentMonth}</CardTitle>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-purple-400">{savingsRate.toFixed(1)}%</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="glass-morphism border-gray-700">
          <CardHeader>
            <CardTitle className="text-white">Top Spending Categories - {currentMonth}</CardTitle>
          </CardHeader>
          <CardContent>
