          ...
          <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
            ...
            <DialogContent className="glass-morphism border-gray-700">
              ...
              <div className="space-y-4">
                ...
                <Button onClick={handleAddTransaction} className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700">
                  Add Transaction
                </Button>
              </div>
            </DialogContent>
          ...
          <CardContent>
            <div className="space-y-4">
              {filteredTransactions.map((transaction) => (
                <div key={transaction.id} className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg hover:bg-gray-800 transition-colors">
        ...
        <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
          <DialogContent className="glass-morphism border-gray-700">
            ...
            <div className="space-y-4">
              ...
              <Button onClick={handleEditTransaction} className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700">
                Update Transaction
              </Button>
            </div>
          </DialogContent>
